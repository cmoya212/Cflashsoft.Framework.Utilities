...
namespace Cflashsoft.Framework.SqlUtility
{
    ...
    /// <summary>
    /// Exposes a forward-only stream whose source is a SQL Server binary column for use with FileStreamResult ActionResult in ASP.NET MVC.
    /// </summary>
    public class SqlBinaryColumnStream : Stream
    {
        ...
        /// </summary>
        /// <param name="reader">The SqlDataReader that contains the data.</param>
        /// <param name="columnIndex">The column position that contains the byte data.</param>
        public SqlBinaryColumnStream(SqlDataReader reader, int columnIndex)
            : this(reader, columnIndex, "application/octet-stream")
        {
        ...
        public SqlBinaryColumnStream(SqlDataReader reader, int columnIndex, string mimeType)
        {
            _reader = reader;
